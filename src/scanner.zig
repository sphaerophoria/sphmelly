...
pub fn main() !void {
    ...
    var bars = try barcode_gen.makeBars(
        .{
            .cl_alloc = &cl_alloc,
            .rand_params = stage1_config.data.rand_params,
            .extract_params = stage1_config.data.extract_params,
            .enable_backgrounds = stage1_config.data.enable_backgrounds,
            .num_images = stage1_config.data.batch_size,
            .label_in_frame = stage1_config.data.label_in_frame,
            .confidence_metric = stage1_config.data.confidence_metric,
    ...
    const resampled = try math_executor.downsample(
        &cl_alloc,
        reshaped_bars,
        stage1_config.data.render_size,
        stage1_multisample,
    );
